namespace DS.Showdown.Game
{
	partial class TeamForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.pitcher = new System.Windows.Forms.ColumnHeader();
			this.starterPanel = new DS.Showdown.Widgets.CollapsiblePanel();
			this.starterListView = new System.Windows.Forms.ListView();
			this.starters = new System.Windows.Forms.ColumnHeader();
			this.wins = new System.Windows.Forms.ColumnHeader();
			this.losses = new System.Windows.Forms.ColumnHeader();
			this.saves = new System.Windows.Forms.ColumnHeader();
			this.era = new System.Windows.Forms.ColumnHeader();
			...
			this.average = new System.Windows.Forms.ColumnHeader();
			this.slug = new System.Windows.Forms.ColumnHeader();
			...
			// pitcher
			// 
			this.pitcher.Text = "pitcher";
			this.pitcher.Width = 200;
			// 
			// starterPanel
			// 
